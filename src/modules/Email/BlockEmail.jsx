  ...
  return (
    <div className={style.Subscribe}>
      <div className={style.email}>
        <h2>Подписаться</h2>
        <p>
          Подпишитесь, чтобы получать последние новости о продажах, новых
          выпусках и многом другом...
        </p>
      ...
      <div className={style.InfoEmail}>
        <div className={style.hand}>
          <Hand />
          <p>Связанная рука Красиво упакованный Букеты</p>
        </div>
        ...
        <div className={style.protection}>
          <Protection />
          <p>
            Безопасные платежи и превосходное качество Обслуживание клиентов
          </p>
        </div>
      </div>
    </div>
